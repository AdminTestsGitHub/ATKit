...
@implementation ATChatMoreViewItem
 ...
 *  @return item
 */
+ (ATChatMoreViewItem *) createChatBoxMoreItemWithTitle:(NSString *)title imageName:(NSString *)imageName{
    ATChatMoreViewItem *item = [[ATChatMoreViewItem alloc] init];
    item.title = title;
